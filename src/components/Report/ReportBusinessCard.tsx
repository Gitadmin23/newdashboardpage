...
function ReportBusinessCard() {
  return (
    <HStack borderWidth={'0.5px'} borderColor={'lightgrey'} borderRadius={'32px 0px 32px 32px'} width='90%' height={'206px'} padding='5px' marginBottom={'20px'}>
        ...
        <Box flex='1' height={'100%'} borderRadius={'32px 0px 32px 32px'} bg='whitesmoke' position={'relative'}>
            <Box width='71px' height='71px' borderRadius={"709.29px 0px 709.29px 709.29px"} position={'absolute'} right={'20px'} top={'20px'} borderWidth={'3px'} borderColor={'white'} bg='lightgrey' ></Box>
        </Box>
...
export default ReportBusinessCard